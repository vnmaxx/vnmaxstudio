  ...
  load() {
    try {
      ...
      if (parsed && typeof parsed === 'object') {
        return { perfis: parsed.perfis || {}, roteiros: parsed.roteiros || [], calendario: parsed.calendario || [], posts: parsed.posts || [], blueprints: parsed.blueprints || [] };
      }
    } catch {}
    return { perfis: {}, roteiros: [], calendario: [], posts: [], blueprints: [] };
  }
