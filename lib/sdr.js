...
Gere a próxima mensagem de abordagem para ESTE lead, adaptada a ele e ao canal "${lead.canal || 'instagram'}", seguindo a voz e as regras da VNMAX acima. Se a etapa for NOVO, faça a PRIMEIRA mensagem (abertura). Retorne 1 a 2 blocos no seu formato <<<MSG>>>{...}<<<FIM>>>.`;
}
