...
<script type="module">
  ...
  import { getFirestore, collection, addDoc, getDocs, onSnapshot, doc, setDoc, deleteDoc, serverTimestamp } from 'https://www.gstatic.com/firebasejs/10.12.0/firebase-firestore.js';
  const app = initializeApp(${JSON.stringify(config)});
  const db = getFirestore(app);
  window.VNMAX_FB = { db, collection, addDoc, getDocs, onSnapshot, doc, setDoc, deleteDoc, serverTimestamp, clienteId: ${JSON.stringify(safeCol(clienteId))} };
